...
DEFAULT_CONFIG = {
    ...
    "max_concurrent": 16,  # concurrent API calls
    ...
    "process_judge_end_step": 500,  # after 500 steps, disable or reduce
    "process_judge_decay_after": 500,  # gradually reduce frequency after this
    "process_judge_only_tied": True,  # only judge groups where outcome is tied
...
class LLMJudgeClient:
    ...
    def _call_api_sync(self, prompt: str) -> Optional[str]:
        """Synchronous API call (for use in thread pool)."""
        import requests
