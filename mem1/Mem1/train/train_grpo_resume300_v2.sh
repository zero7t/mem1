#!/bin/bash
# V3 Resume from step 300 (v2): lambda_process=0.6, removed query irrelevance penalty
...
python3 -m grpo_v3.main_ppo_v3 \
  ...
  trainer.experiment_name=V3-grpo-n4-bs96-resume300_v2 \
  trainer.total_epochs=1 \
  trainer.total_training_steps=800 \
  trainer.default_local_dir=verl_checkpoints/V3-grpo-n4-bs96-resume300_v2 \
  max_turns=6 \
  do_search=true \
  ...
  2>&1 | tee -a V3-grpo-n4-bs96-resume300_v2.log
