...
# export EXPERIMENT_NAME=nq-search-r1-ppo-qwen2.5-3b-em-2
...
export EXPERIMENT_NAME=webshop-r1-ppo-qwen2.5-7b-it-em
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_webshop \
    ...
    max_turns=10 \
    retriever.url="http://127.0.0.1:8011/retrieve" \
    retriever.topk=3 \
