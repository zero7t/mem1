#!/bin/bash
# V4.1 Resume from step 300: LLDS fix (mini_batch=192), per-turn LLM judge + retrieval-hit
...
python3 -m grpo_v3.main_ppo_v3 \
  ...
  trainer.experiment_name=V4.1-grpo-n4-bs96-resume300 \
  trainer.total_epochs=1 \
  trainer.total_training_steps=800 \
  trainer.default_local_dir=verl_checkpoints/V4.1-grpo-n4-bs96-resume300 \
  max_turns=6 \
  do_search=true \
  ...
  2>&1 | tee V4.1-grpo-n4-bs96-resume300.log
